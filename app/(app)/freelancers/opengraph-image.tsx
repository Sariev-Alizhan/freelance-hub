...
export const alt = 'FreelanceHub — Каталог фрилансеров'
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          Проверенные фрилансеры из Казахстана и СНГ. Разработка, дизайн, маркетинг, AI.
        </div>

        <div style={{ display: 'flex', gap: '14px', marginBottom: '30px' }}>
          {['Верифицированные профили', 'Прямые сделки', 'Без комиссии'].map(t => (
            <div key={t} style={{
        ...
        <div style={{ fontSize: '18px', color: '#4a4f57' }}>freelance-hub.kz/freelancers</div>
      </div>
    ),
    { ...size }
  )
