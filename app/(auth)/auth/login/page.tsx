...
function OAuthBtn({ provider, label, icon, bg, color = '#fff', border, loading, onClick, wide }: OAuthBtnProps) {
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '360px' }}>
        ...
        <div style={{
          ...
          <OAuthBtn
            provider="google" label="Продолжить с Google" icon={<GoogleIcon />}
            bg="#ffffff" color="#1f1f1f" border="1px solid #dadce0"
            loading={loading} onClick={signIn} wide
          />

          {/* GitHub + Apple — 2 columns */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
            <OAuthBtn provider="github" label="GitHub" icon={<GitHubIcon />} bg="#24292e" loading={loading} onClick={signIn} wide />
            <OAuthBtn provider="apple"  label="Apple"  icon={<AppleIcon />}  bg="#000000" loading={loading} onClick={signIn} wide />
          </div>

          {/* Discord — full width */}
          <OAuthBtn
            provider="discord" label="Продолжить с Discord" icon={<DiscordIcon />}
            bg="#5865F2" loading={loading} onClick={signIn} wide
          />
