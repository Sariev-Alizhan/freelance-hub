...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/vote`,          lastModified: now, changeFrequency: 'daily',   priority: 0.8  },
    { url: `${SITE}/updates`,       lastModified: now, changeFrequency: 'weekly',  priority: 0.75 },
    { url: `${SITE}/modules`,        lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${SITE}/rp-dev`,        lastModified: now, changeFrequency: 'monthly', priority: 0.8  },
    { url: `${SITE}/news`,          lastModified: now, changeFrequency: 'hourly',  priority: 0.85 },
